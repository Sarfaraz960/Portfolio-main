       ...
       <div className="contact__options">
          <article className="contact__option">
            <MdOutlineEmail className="contact__option-icon"/>
              <h4>Email</h4>
              <h5>srfrziqbal@gmail.com</h5>
              <a href="mailto:srfrziqbal@gmail.com" target="_blank">Send a message</a>
          </article>

          <article className="contact__option">
            <FaInstagramSquare className="contact__option-icon" id="har"/>
              <h4>Instagram</h4>
              <h5>sarfaraz._.iqbal</h5>
          ...
          <article className="contact__option">
            <ImWhatsapp className="contact__option-icon" id="keer"/>
              <h4>WhatsApp</h4>
              <h5>+91 9606872218</h5>
              <a href="https://web.whatsapp.com/send?phone+919606872218&text=message&app_absent=0" target="_blank">Send a message</a>
          </article>
